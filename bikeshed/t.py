...
if TYPE_CHECKING:
    ...
    type NodesT = list[NodesT] | NodeT | list[NodeT]
    # In many places I treat lists as an "anonymous" element
    type ElementishT = ElementT | list[NodeT]
    ...
    JSONValueT = TypeVar("JSONValueT", bound="JSONContainer | JSONPrimitive")
    type JSONObject = dict[str, JSONValueT]
    type JSONArray = list[JSONValueT]
